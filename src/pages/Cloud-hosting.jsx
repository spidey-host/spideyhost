...
import CloudHostingPackages from "../components/CloudHostingPackages"; // Updated import to use CloudHostingPackages
import CloudHostingFeatures from "../components/CloudHostingFeatures"; // Assuming CloudHostingFeatures is a new component
import backgroundImage from '../assets/cloud-hosting/cloud-hero.png'; // Updated image path for Cloud Hosting
...
const CloudHosting = () => {
  ...
  return (
    <div style={{ position: 'relative' }}>
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center relative">
          ...
          <div className="lg:w-1/3 text-center lg:text-left lg:mx-8 relative z-10">
            <h1 className="text-3xl font-bold sm:text-4xl lg:text-5xl leading-snug tracking-tight relative">
              <span style={{ color: '#4E54C8' }}>Cloud Hosting</span> 
            ...
            <p className="mt-4 text-base sm:text-lg max-w-2xl mx-auto lg:mx-0 text-gray-700">
              Fast, scalable, and secure cloud hosting solutions designed to meet the demands of your growing business.
            </p>
      ...
      {/* Features Section */}
      <CloudHostingFeatures /> {/* Added Cloud Hosting features section */}

      {/* Hosting Plans Section */}
      <div ref={plansRef}>
        <CloudHostingPackages /> {/* Updated to use CloudHostingPackages */}
      </div>
